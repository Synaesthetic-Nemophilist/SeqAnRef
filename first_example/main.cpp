...
// template function specialized for String<AminoAcid> type --> ONLY RUN IF SECOND ARG IS OF TYPE String<AminoAcid>
...
/**
THIS MINI APP DESCRIBES TEMPLATE SPECIALIZATION, REFERΕNCES, CONSTS AND TAGS
 **/